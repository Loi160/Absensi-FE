    ...
    <div className="hrd-container">
      ...
      <aside className={`sidebar ${sidebarOpen ? "open" : ""}`}>
        ...
        <nav className="menu-nav">
          ...
          <div className="menu-item active" onClick={() => handleNav("/managerCabang/datakaryawan")}><div className="menu-left"><img src={iconKaryawan} alt="" className="menu-icon-main" /><span className="menu-text-main">Data Karyawan</span></div></div>
