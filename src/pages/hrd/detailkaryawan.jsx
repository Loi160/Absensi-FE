...
const DetailKaryawan = () => {
  ...
  const semuaCabangAmaga = ["F&B Jakarta", "F&B Sudirman (Sub)", "F&B Kemang (Sub)", "Jam Tangan Jkt", "Pakaian Jkt", "Sepatu Jkt"];
    ...
    <div className="hrd-container">
      ...
      <aside className={`sidebar ${sidebarOpen ? "open" : ""}`}>
        ...
        <nav className="menu-nav">
          ...
          {!isManager && (
            <div className="menu-item" onClick={() => handleNav(`${basePath}/kelolacabang`)}><div className="menu-left"><img src={iconKelola} alt="" className="menu-icon-main" /><span className="menu-text-main">Kelola Cabang</span></div></div>
          )}
          ...
          {!isManager && (
            <div className="menu-item has-arrow" onClick={() => handleNav(`${basePath}/absenmanual`)}><div className="menu-left"><img src={iconKehadiran} alt="" className="menu-icon-main" /><span className="menu-text-main">Kehadiran</span></div><img src={iconBawah} alt="" className="arrow-icon-main" /></div>
          )}
          ...
          <form onSubmit={handleSaveEdit}>
            <div className="form-grid-3">
              ...
              <div className="form-group">
                ...
                {isEditing ? (
                  <select name="jenisKelamin" className="input-gray" value={formData.jenisKelamin} onChange={handleInputChange} required><option value="Laki-laki">Laki-laki</option><option value="Perempuan">Perempuan</option></select>
                ) : (
              ...
              <div className="form-group">
                ...
                {isEditing ? (
                  <select name="cabang" className="input-gray" value={formData.cabang} onChange={handleInputChange} required>
                    {semuaCabangAmaga.map((cbg, idx) => <option key={idx} value={cbg}>{cbg}</option>)}
                  </select>
                ) : (
              ...
              <div className="form-group">
                ...
                {isEditing ? (
                  <select name="status" className="input-gray" value={formData.status} onChange={handleInputChange} required><option value="Aktif">Aktif</option><option value="Resign">Resign</option></select>
                ) : (
